        ...
        <div className="container-x">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">
              Since its establishment, IUCB has continuously expanded its international presence by
              strengthening accreditation frameworks, supporting certification bodies, developing
              professional competency, and introducing trusted digital verification technologies for
        ...
        <div className="container-x grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-5 text-muted-foreground leading-relaxed">
              ...
              providers, regulatory authorities, and strategic partners committed to strengthening
              trust, competence, and compliance worldwide.
            </p>
